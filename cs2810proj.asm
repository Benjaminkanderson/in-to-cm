...
GLOBAL_DATA_START
L1_project .FILL lc3_L1_project
scanf .FILL lc3_scanf
printf .FILL lc3_printf
L6_project .FILL #0
L5_project .STRINGZ "The measurement in centimeters is %d"
L4_project .STRINGZ "%d"
L3_project .STRINGZ "Please enter a value in inches: "
L2_project .FILL #2
.END